...
open class BadgeHub: NSObject {
    ...
    open private(set) var countLabel: UILabel? {
        didSet {
            countLabel?.text = "\(count)"
            checkZero()
        }
    ...
    open func setView(_ view: UIView?, andCount startCount: Int) {
        curOrderMagnitude = 0
    ...
    open func setCircleAtFrame(_ frame: CGRect) {
    ...
    open func setCircleColor(_ circleColor: UIColor?, label labelColor: UIColor?) {
    ...
    ///   - width: Border width.
    open func setCircleBorderColor(_ color: UIColor?, borderWidth width: CGFloat) {
    ...
    open func moveCircleBy(x: CGFloat, y: CGFloat) {
    ...
    open func scaleCircleSize(by scale: CGFloat) {
    ...
    open func increment(by amount: Int) {
        count += amount
    }
    ...
    open func decrement(by amount: Int) {
        if amount >= count {
            count = 0
            return
        }
    ...
    open func setMaxCount(to count: Int) {
        maxCount = count
    }
    ...
    open func setCount(_ newCount: Int) {
        count = newCount
